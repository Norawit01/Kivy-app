...
class GamePlay(Screen):
    ...
    def update(self, dt):
        # lets move our code 4 lines to the right by pressing (Ctrl)+(]) together
    ...
    # lets start getting ghost movement updates
    def update_ghost1(self,dt):
        self.ghost1.strategy()

    def do_strategy(self,dt):
        # were are letting our ghost know were the player is
...
class PacmanApp(App):
    def build(self):
        ...
        Clock.schedule_once(start_delay,25)
