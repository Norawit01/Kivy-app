...
# import and use our algorithym here
from Dijkstra import pts_graph, distance, argmin

#to create our graph we need close list and we also need points.
# we have the points i.e bpoint we need to create a list of points that are close
# to create points we simply use our maze diagram
...
class Player(Widget):
    ...
    # point where our pacman is
    close_point = 1

    # Lets give our pacman powers :)
    powerup =0
    ...
    def move(self):
        ...
        # we put same code in our player class
        self.close_point = \
